// ==============================================================================
// Véritas v2.12 — /lib/sandboxTemplates.js
// ==============================================================================
...
<body class="bg-gray-900 text-white">
  <header class="py-20" style="background: linear-gradient(135deg, ${color}22, transparent);">
    <div class="container mx-auto px-6 text-center">
      ...
      <p class="text-xl text-gray-300">Página generada con Tailwind CSS y Véritas v2.12</p>
  ...
  <footer class="py-8 text-center text-gray-500 border-t border-gray-800">
    <p>© 2025 ${title} — Generado por Véritas v2.12</p>
  </footer>
</body>
</html>`;
