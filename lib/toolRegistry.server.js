// ==============================================================================
// Véritas v2.2 — /lib/toolRegistry.server.js
// ==============================================================================
...
//
// Responsabilidades:
//   - Declarar las 22 tools con su schema (args) y allowedRoles.
...
export const TOOL_REGISTRY_SERVER = {
  ...
  cohere_infer: { description: "Reservado para inferencia auxiliar Cohere.", native: false, handler: "./tools/cohere_infer.js",
    args: { prompt: { type: "string", required: true } }, allowedRoles: ["agent", "estratega", "fast"], requiresOauth: null, usesKeyRotation: null,
  },
