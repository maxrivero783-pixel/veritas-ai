...
//
// Responsabilidades:
//   - Declarar las 61 tools con su schema (args) y allowedRoles.
...
export const TOOL_REGISTRY_SERVER = {
  ...
  web_search: {
    ...
    allowedRoles: ["agent", "pensador", "fast"],
    requiresOauth: null,
  ...
  semantic_scholar_search: {
    ...
    allowedRoles: ["agent", "fast"], requiresOauth: null, usesKeyRotation: null,
  },
  openalex_search: {
  ...
  open_meteo_weather: { description: "Clima actual y pronóstico con Open-Meteo.", native: false, handler: "./tools/open_meteo_weather.js",
    args: { latitude: { type: "number", required: true }, longitude: { type: "number", required: true }, forecast_days: { type: "number", required: false, min: 1, max: 16 } }, allowedRoles: ["agent", "fast"], requiresOauth: null, usesKeyRotation: null,
  },
  crtsh_lookup: { description: "Busca certificados y subdominios públicos en crt.sh.", native: false, handler: "./tools/crtsh_lookup.js",
    args: { domain: { type: "string", required: true }, limit: { type: "number", required: false, min: 1, max: 100 } }, allowedRoles: ["agent", "fast"], requiresOauth: null, usesKeyRotation: null,
  },
  rdap_lookup: { description: "Consulta RDAP público para dominios, IPs y ASNs.", native: false, handler: "./tools/rdap_lookup.js",
    args: { query: { type: "string", required: true }, type: { type: "string", required: false, enum: ["domain", "ip", "autnum"] } }, allowedRoles: ["agent", "fast"], requiresOauth: null, usesKeyRotation: null,
  },
  cisa_kev_search: { description: "Busca vulnerabilidades explotadas conocidas en CISA KEV.", native: false, handler: "./tools/cisa_kev_search.js",
    args: { query: { type: "string", required: false }, cve: { type: "string", required: false }, vendor: { type: "string", required: false }, limit: { type: "number", required: false, min: 1, max: 50 } }, allowedRoles: ["agent", "fast"], requiresOauth: null, usesKeyRotation: null,
  },
  nvd_cve_search: { description: "Busca CVEs y detalles de severidad en NVD.", native: false, handler: "./tools/nvd_cve_search.js",
    args: { cve: { type: "string", required: false }, keyword: { type: "string", required: false }, limit: { type: "number", required: false, min: 1, max: 20 } }, allowedRoles: ["agent", "fast"], requiresOauth: null, usesKeyRotation: null,
  },
  ...
  geonames_search: { description: "Busca lugares con GeoNames.", native: false, handler: "./tools/geonames_search.js",
    args: { query: { type: "string", required: true }, limit: { type: "number", required: false, min: 1, max: 50 }, country: { type: "string", required: false } }, allowedRoles: ["agent", "fast"], requiresOauth: null, usesKeyRotation: null,
  },
  nasa_search: { description: "Busca contenido público en NASA Image and Video Library.", native: false, handler: "./tools/nasa_search.js",
    args: { query: { type: "string", required: true }, media_type: { type: "string", required: false, enum: ["image", "video", "audio"] }, limit: { type: "number", required: false, min: 1, max: 20 } }, allowedRoles: ["agent", "fast"], requiresOauth: null, usesKeyRotation: null,
  },
  sec_edgar_search: { description: "Consulta filings recientes de SEC EDGAR.", native: false, handler: "./tools/sec_edgar_search.js",
    args: { ticker: { type: "string", required: false }, cik: { type: "string", required: false } }, allowedRoles: ["agent", "fast"], requiresOauth: null, usesKeyRotation: null,
  },
  cohere_infer: { description: "Reservado para inferencia auxiliar Cohere.", native: false, handler: "./tools/cohere_infer.js",
    args: { prompt: { type: "string", required: true } }, allowedRoles: ["agent", "fast"], requiresOauth: null, usesKeyRotation: "cohere",
  },
  email_report: { description: "Envía un reporte opt-in por Brevo.", native: false, handler: "./tools/email_report.js",
    args: { subject: { type: "string", required: false }, title: { type: "string", required: false }, summary: { type: "string", required: false }, text: { type: "string", required: false }, html: { type: "string", required: false }, consent: { type: "boolean", required: true } }, allowedRoles: ["agent", "fast"], requiresOauth: null, usesKeyRotation: "brevo",
  },
