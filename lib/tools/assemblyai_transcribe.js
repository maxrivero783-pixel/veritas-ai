// ==============================================================================
// Véritas v2.12 — /lib/tools/assemblyai_transcribe.js
// ==============================================================================
...
export async function run(args, ctx) {
  ...
  try {
    ...
    if (!wait_for_completion) {
      return {
        status: "pending",
        output: `AssemblyAI job iniciado. TranscriptId: ${transcriptId}. Para respetar Cloudflare Free Tier no se espera la transcripción en esta request. Reintenta/consulta el transcriptId más tarde.`,
        latency_ms: Date.now() - startTs,
        extra: { transcript_id: transcriptId, audio_url, async: true },
      };
    }
