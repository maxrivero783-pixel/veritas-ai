// ==============================================================================
// Véritas v2.4 — /lib/keyRotator.js
// ==============================================================================
...
export const SERVICE_REGISTRY = {
  ...
  // --- Email ---
  brevo: {
    secretPrefix: "BREVO_API_KEY",
    cooldownMs: 60_000,
    maxRetries: 1,
    quotaEndpoint: "https://api.brevo.com/v3/account",
    healthCheckMethod: "GET",
    healthCheckHeaders: (key) => ({ "api-key": key, "Accept": "application/json" }),
  },
};
