...
// ==============================================================================
// Véritas v2.12 — /lib/services/oauth/github.js
// ==============================================================================
// Adaptador OAuth GitHub (Authorization Code Flow; sin PKCE: las OAuth Apps no lo soportan).
...
export function getAuthUrl({ clientId, redirectUri, scopes, state, codeChallenge }) {
  ...
  // v2.12l: GitHub OAuth Apps NO soportan PKCE; enviar code_challenge puede
  // hacer fallar la autorización. La seguridad la cubren state + client_secret.
  return url.toString();
}
...
export async function exchangeCode({ code, codeVerifier, clientId, clientSecret, redirectUri }) {
  ...
  // v2.12l: sin code_verifier (GitHub OAuth Apps no usan PKCE).
