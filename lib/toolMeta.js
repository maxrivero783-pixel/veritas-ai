...
export const TOOL_CATEGORIES = {
  ...
  inference: {
    ...
    keywords: ["cerebras", "cohere", "generar", "resumen ia", "inferencia"],
  },
  misc: {
    label: "Utilidades",
...
// ------------------------------------------------------------------------------
// tool → categoría. Cubre las 62 tools del registro.
// ------------------------------------------------------------------------------
export const TOOL_CATEGORY = {
  ...
  // Inferencia
  cerebras_infer: "inference", cohere_infer: "inference",
  // Misc
  email_report: "misc",
};
...
export const TOOL_META = {
  ...
  cerebras_infer: { when_to_use: "Inferencia LLM directa vía Cerebras.", tags: ["llm"], limitations: "Requiere clave Cerebras.", example: 'cerebras_infer(prompt="...")' },
