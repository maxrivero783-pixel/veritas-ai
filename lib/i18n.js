...
export const STRINGS = {
  es: {
    "app.title": "Véritas",
    "app.tagline": "Información es ventaja. La ventaja es tuya.",

    "nav.agent": "Agente",
    "nav.estratega": "Estratega",
    "nav.fast": "Fast",
    ...
    "auth.subtitle": "Accede con tu email y contraseña",
    "auth.login": "Entrar",
    ...
    "toast.uncensoredFallback": "Enrutando al Estratega GLM (modo permisivo)...",
    ...
    "settings.skills.hint": "Habilita skills para inyectar directivas especializadas. Hay 77 built-in, referencias bajo demanda y custom skills persistidas en D1.",
    ...
    "settings.about.desc": "Centro de mando IA con Agente, Estratega, Fast, Prompt Arquitecto, sandbox telemétrico, 77 skills, 43 tools y diseño free-tier-first.",
    ...
    "title.thinking": "Pensador",
    "title.codeFirst": "Code-first",
  },

  en: {
    "app.title": "Véritas",
    "app.tagline": "Information is advantage. The advantage is yours.",

    "nav.agent": "Agent",
    "nav.estratega": "Strategist",
    "nav.fast": "Fast",
    ...
    "toast.uncensoredFallback": "Routing to GLM Strategist (permissive mode)...",
    "stream.linesProcessing": [
    ...
    "settings.skills.hint": "Enable skills to inject specialized directives. There are 77 built-ins, on-demand references, and custom skills persisted in D1.",
    "settings.skills.search": "Search skill...",
    "settings.skills.edit": "✎ Edit skills",
    "settings.skills.editHint": "Create, modify or audit skills. You can also ask the agent to create one by describing it (skill-creator).",
    ...
    "settings.about.desc": "AI command center with Agent, Strategist, Fast, Prompt Architect, telemetry sandbox, 77 skills, 43 tools, and a free-tier-first design.",
    ...
    "title.scrape": "Scraping",
    "title.thinking": "Thinker",
    "title.codeFirst": "Code-first",
  },

  fr: {
    "app.title": "Véritas",
    "app.tagline": "L'information est un avantage. L'avantage est à toi.",

    "nav.agent": "Agent",
    "nav.estratega": "Stratège",
    "nav.fast": "Fast",
    ...
    "auth.subtitle": "Connectez-vous avec votre email et mot de passe",
    ...
    "toast.uncensoredFallback": "Routage vers le Stratège GLM (mode permissif)...",
    "stream.linesProcessing": [
    ...
    "settings.skills.hint": "Activez les skills pour injecter des directives spécialisées. Il y a 77 built-ins, des références à la demande et des skills personnalisées persistées dans D1.",
    "settings.skills.search": "Rechercher skill...",
    "settings.skills.edit": "✎ Modifier les skills",
    "settings.skills.editHint": "Créez, modifiez ou auditez des skills. Vous pouvez aussi demander à l’agent d’en créer une en la décrivant (skill-creator).",
    ...
    "settings.about.desc": "Centre de commande IA avec Agent, Stratège, Fast, Prompt Architecte, sandbox télémétrique, 77 skills, 43 tools et conception free-tier-first.",
