// ==============================================================================
// Véritas v2.4 — /lib/contextManager.js
// ==============================================================================
...
//
// No hace fetch directo al modelo; delega el resumen a Puter.ai.chat desde app.js
// (porque puter debe estar cargado globalmente y solo app.js lo orquesta).
// ==============================================================================
...
export const DEFAULT_SETTINGS = {
  ...
  maxToolIterations: 5,         // límite del Tool Caller loop
};
...
//
// Usa Puter.ai.chat con GLM-4.5-Flash. Si puter no está disponible, devuelve
// un resumen trivial (primeras N palabras de cada mensaje).
// ------------------------------------------------------------------------------
export async function generateSummary({ droppedMessages, previousSummary, allMessagesCount }) {
  ...
  try {
    ...
    if (!text) throw new Error("Respuesta vacía de GLM-Flash");
