...
export const FALLBACK_CHAINS = {
  // Agente unificado: modo normal, Pensador (toggle) y Code-first (toggle)
  // comparten un pool vivo y gratuito en OpenRouter/Puter.
  agent: [
  ...
  // Alias interno para compatibilidad con chats antiguos de categoría coder.
  coder: [
    "cohere/north-mini-code:free",
    "poolside/laguna-s-2.1:free",
    "poolside/laguna-xs-2.1:free",
  ...
  // Alias interno para compatibilidad con modo Pensador standalone.
  pensador: [
    "nvidia/nemotron-3-ultra-550b-a55b:free",
    "nvidia/nemotron-3-super-120b-a12b:free",
    "nvidia/nemotron-3-nano-30b-a3b:free",
  ...
  // Estratega: GLM es el candidato más permisivo en el stack free actual.
  estratega: [
    "z-ai/glm-4.7-flash",
    "z-ai/glm-4.6v-flash",
    "z-ai/glm-4.5-flash",
  ...
  // Fast y Prompt Arquitecto: GLM 4.7 Flash primario con degradación Puter.
  fast: [
    "z-ai/glm-4.7-flash",
    "z-ai/glm-4.6v-flash",
    "z-ai/glm-4.5-flash",
...
export const MODEL_PROVIDER = {
  ...
  // General/coding free OpenRouter
  ...
  // Puter GLM
  "z-ai/glm-4.7-flash": "puter",
  "z-ai/glm-4.6v-flash": "puter",
  "z-ai/glm-4.5-flash": "puter",
};

// ------------------------------------------------------------------------------
// Mapeo modelId → roleKey (compatibilidad; la UI puede sobreescribir por categoría).
// ------------------------------------------------------------------------------
export const MODEL_TO_ROLE = {
  ...
  "z-ai/glm-4.7-flash": "fast",
  "z-ai/glm-4.6v-flash": "fast",
...
export const MODEL_CONTEXT_LIMIT = {
  ...
  "z-ai/glm-4.7-flash": 131072,
  "z-ai/glm-4.6v-flash": 131072,
