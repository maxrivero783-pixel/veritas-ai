...
export const FALLBACK_CHAINS = {
  ...
  // v2.13b: primario = Command R+ (modelo NO-thinking ⇒ thinking off REAL).
  // Command A+ rechaza thinking:{type:"disabled"} (422) y siempre razona,
  // así que queda como fallback de emergencia junto a Command R.
  fast: [
