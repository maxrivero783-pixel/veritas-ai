// ==============================================================================
// Véritas v2.4 — /lib/fallbackChains.js
// ==============================================================================
...
export const FALLBACK_CHAINS = {
  ...
  // GLM-Flash como auxiliar, luego Hermes-3 y Qwen3 (fallback global).
  agent: [
    ...
    "z-ai/glm-4.5-flash",                                      // auxiliar (declarar parcial)
  ...
  // Estratega: Hermes-3 primario (OpenRouter), fallback a Qwen3 y GLM-Flash.
  estratega: [
    "nousresearch/hermes-3-llama-3.1-405b:free",              // primario (OpenRouter)
    "qwen/qwen3-next-80b-a3b-instruct:free",                  // fallback 1 (OpenRouter)
    "z-ai/glm-4.5-flash",                                      // fallback 2 (Puter)
  ],
...
export const MODEL_TO_ROLE = {
  ...
  "nousresearch/hermes-3-llama-3.1-405b:free": "estratega",  // Estratega (auxiliar principal)
