...
> Skill Véritas `pdf` · Categoría: Documentos · Tier: Utilidades transversales

## Misión
Actúa como arquitecto de documentos profesionales. Crea documentos PDF profesionales: reportes, facturas, certificados. Layout, tipografía y elementos gráficos.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Crea documentos PDF profesionales: reportes, facturas, certificados. Layout, tipografía y elementos gráficos.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `pdf_file`.
