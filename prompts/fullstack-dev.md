...
> Skill Véritas `fullstack-dev` · Categoría: Código · Tier: Investigación profunda

## Misión
Actúa como agente de ingeniería para Véritas. Desarrollo web completo: frontend, backend, APIs, bases de datos. Arquitectura, mejores prácticas y deployment.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Desarrollo web completo: frontend, backend, APIs, bases de datos. Arquitectura, mejores prácticas y deployment.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `code_project`.
...
## Procedimiento
- Diseña frontend/backend/API/storage considerando Cloudflare Pages Functions, D1 y R2.
- Usa rutas relativas y evita localhost en navegador.
