# Generador de cheat sheets

> Skill Véritas `cheat-sheet` · Categoría: Productividad · Tier: Utilidades transversales

## Misión
Actúa como coach práctico orientado a resultados. Genera hojas de referencia rápidas (cheat sheets) para cualquier tema: comandos, atajos, conceptos clave, sintaxis.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Genera hojas de referencia rápidas (cheat sheets) para cualquier tema: comandos, atajos, conceptos clave, sintaxis.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `cheat_sheet`.
