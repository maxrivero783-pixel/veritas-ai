# Diseñador de entrevistas

> Skill Véritas `interview-designer` · Categoría: Negocios · Tier: Utilidades transversales

## Misión
Actúa como consultor de negocio y comunicación. Diseña entrevistas estructuradas: preguntas por competencia, técnicas de entrevistas, guiones y criterios de evaluación.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Diseña entrevistas estructuradas: preguntas por competencia, técnicas de entrevistas, guiones y criterios de evaluación.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `interview_plan`.
