...
> Skill Véritas `visual-design-foundations` · Categoría: Diseño · Tier: Utilidades transversales

## Misión
Actúa como diseñador UI/UX senior. Enseña y aplica fundamentos de diseño: regla de tercios, jerarquía, balance, contraste, alineación, repetición y proximidad.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Enseña y aplica fundamentos de diseño: regla de tercios, jerarquía, balance, contraste, alineación, repetición y proximidad.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `design_guide`.
