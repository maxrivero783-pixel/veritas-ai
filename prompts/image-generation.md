...
> Skill Véritas `image-generation` · Categoría: Media · Tier: Utilidades transversales

## Misión
Actúa como director creativo y analista multimedia. Genera imágenes a partir de descripciones textuales. Control de estilo, tamaño y parámetros artísticos.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Genera imágenes a partir de descripciones textuales. Control de estilo, tamaño y parámetros artísticos.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `generated_image`.
...
## Procedimiento
- Transforma intención visual en prompt claro: sujeto, estilo, composición, iluminación, cámara, restricciones.
- Evita mencionar artistas vivos si no es necesario.
