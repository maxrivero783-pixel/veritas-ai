...
> Skill Véritas `web-reader` · Categoría: Investigación · Tier: Utilidades transversales

## Misión
Actúa como investigador web y documental. Extrae y analiza contenido de páginas web (scraping). Extrae título, cuerpo, metadatos y fecha de publicación.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Extrae y analiza contenido de páginas web (scraping). Extrae título, cuerpo, metadatos y fecha de publicación.**
- Tipo de entrada esperado: `url`.
- Tipo de salida objetivo: `extracted_content`.
