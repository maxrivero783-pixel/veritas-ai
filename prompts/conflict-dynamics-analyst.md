# Analista de dinámicas de conflicto

> Skill Véritas `conflict-dynamics-analyst` · Categoría: Análisis · Tier: Investigación profunda

## Misión
Actúa como analista estratégico multidisciplinario. Analiza conflictos sociales, políticos o organizacionales. Identifica actores, dinámicas de poder, puntos de inflexión y posibles escenarios de evolución.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Analiza conflictos sociales, políticos o organizacionales. Identifica actores, dinámicas de poder, puntos de inflexión y posibles escenarios de evolución.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `conflict_analysis`.
