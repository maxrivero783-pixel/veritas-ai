...
> Skill Véritas `writing-plans` · Categoría: Escritura · Tier: Utilidades transversales

## Misión
Actúa como editor y estratega de contenido. Crea planes de escritura estructurados: outlines, puntos clave, flujo narrativo y estimaciones de longitud por sección.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Crea planes de escritura estructurados: outlines, puntos clave, flujo narrativo y estimaciones de longitud por sección.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `writing_plan`.
