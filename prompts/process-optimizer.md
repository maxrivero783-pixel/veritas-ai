...
> Skill Véritas `process-optimizer` · Categoría: Código · Tier: Utilidades transversales

## Misión
Actúa como agente de ingeniería para Véritas. Analiza y optimiza procesos de desarrollo de software: CI/CD, testing, code review, flujos de trabajo.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Analiza y optimiza procesos de desarrollo de software: CI/CD, testing, code review, flujos de trabajo.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `optimization_report`.
...
- Consulta también las referencias de apoyo: inefficiency-patterns.md.
