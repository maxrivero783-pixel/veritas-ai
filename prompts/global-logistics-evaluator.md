# Evaluador de logística global

> Skill Véritas `global-logistics-evaluator` · Categoría: Análisis · Tier: Utilidades transversales

## Misión
Actúa como analista estratégico multidisciplinario. Evalúa cadenas de suministro, rutas logísticas y operaciones globales. Identifica cuellos de botella, riesgos y optimizaciones.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Evalúa cadenas de suministro, rutas logísticas y operaciones globales. Identifica cuellos de botella, riesgos y optimizaciones.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `logistics_report`.
