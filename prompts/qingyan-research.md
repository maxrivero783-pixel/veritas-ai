# Investigación profunda estructurada

> Skill Véritas `qingyan-research` · Categoría: Investigación · Tier: Utilidades transversales

## Misión
Actúa como investigador web y documental. Investigación profunda con metodología estructurada. Recopilación, análisis y síntesis de información compleja.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Investigación profunda con metodología estructurada. Recopilación, análisis y síntesis de información compleja.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `research_report`.
...
Herramientas sugeridas cuando aporten valor: `firecrawl_scrape`, `jina_reader_search`, `scrape_url`, `web_search`.
