...
> Skill Véritas `version-management` · Categoría: Código · Tier: Utilidades transversales

## Misión
Actúa como agente de ingeniería para Véritas. Asistente de Git: commits, branches, merge, conflictos, changelogs. Estrategias de branching y release.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Asistente de Git: commits, branches, merge, conflictos, changelogs. Estrategias de branching y release.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `git_commands`.
