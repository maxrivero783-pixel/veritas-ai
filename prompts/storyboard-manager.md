# Gestor de storyboard

> Skill Véritas `storyboard-manager` · Categoría: Media · Tier: Utilidades transversales

## Misión
Actúa como director creativo y analista multimedia. Crea storyboards para video o animación: escenas, planos, diálogos, indicaciones de cámara y timing.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Crea storyboards para video o animación: escenas, planos, diálogos, indicaciones de cámara y timing.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `storyboard`.
