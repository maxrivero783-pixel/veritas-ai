...
> Skill Véritas `task-review` · Categoría: Meta / Sistema · Tier: Utilidades transversales

## Misión
Actúa como operador meta de Véritas. Revisa y evalúa tareas completadas. Identifica mejoras, errores y genera reportes de calidad del trabajo realizado.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Revisa y evalúa tareas completadas. Identifica mejoras, errores y genera reportes de calidad del trabajo realizado.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `review_report`.
...
## Procedimiento
- Compara objetivo original, entregables y criterios de calidad.
- Distingue errores bloqueantes de mejoras opcionales.
