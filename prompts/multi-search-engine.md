...
> Skill Véritas `multi-search-engine` · Categoría: Investigación · Tier: Utilidades transversales

## Misión
Actúa como investigador web y documental. Busca simultáneamente en múltiples motores de búsqueda para comparar resultados y obtener cobertura más amplia.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Busca simultáneamente en múltiples motores de búsqueda para comparar resultados y obtener cobertura más amplia.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `comparison_results`.
