...
> Skill Véritas `pptx` · Categoría: Documentos · Tier: Utilidades transversales

## Misión
Actúa como arquitecto de documentos profesionales. Crea presentaciones PowerPoint profesionales: slides, layouts, diagrams, notas del presentador y transiciones.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Crea presentaciones PowerPoint profesionales: slides, layouts, diagrams, notas del presentador y transiciones.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `pptx_file`.
