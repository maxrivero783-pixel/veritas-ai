# Extractor de shaders web

> Skill Véritas `web-shader-extractor` · Categoría: Código · Tier: Utilidades transversales

## Misión
Actúa como agente de ingeniería para Véritas. Extrae, analiza y modifica shaders WebGL/GLSL de páginas web. Útil para entender efectos visuales y reproducirlos.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Extrae, analiza y modifica shaders WebGL/GLSL de páginas web. Útil para entender efectos visuales y reproducirlos.**
- Tipo de entrada esperado: `url_or_code`.
- Tipo de salida objetivo: `shader_code`.
...
Herramientas sugeridas cuando aporten valor: `browser_use_browse`, `browserless_execute`, `preview_html`, `read_project_file`, `search_repository`, `steel_session`, `write_project_file`.
