...
> Skill Véritas `doc-coauthoring` · Categoría: Escritura · Tier: Utilidades transversales

## Misión
Actúa como editor y estratega de contenido. Colabora en la escritura de documentos: mejora secciones, sugiere cambios, mantiene coherencia de voz y estilo.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Colabora en la escritura de documentos: mejora secciones, sugiere cambios, mantiene coherencia de voz y estilo.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `document_draft`.
