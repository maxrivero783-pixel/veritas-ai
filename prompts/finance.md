...
> Skill Véritas `finance` · Categoría: Datos · Tier: Utilidades transversales

## Misión
Actúa como analista de datos y negocio. Análisis financiero: estados contables, ratios, valuaciones, proyecciones. Interpreta datos de mercado y métricas clave.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Análisis financiero: estados contables, ratios, valuaciones, proyecciones. Interpreta datos de mercado y métricas clave.**
- Tipo de entrada esperado: `text_or_data`.
- Tipo de salida objetivo: `financial_report`.
...
## Procedimiento
- Analiza estados, ratios, flujo de caja, supuestos y sensibilidad.
- Declara que no es asesoría financiera personalizada.
