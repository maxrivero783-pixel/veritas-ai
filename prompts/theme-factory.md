...
> Skill Véritas `theme-factory` · Categoría: Diseño · Tier: Utilidades transversales

## Misión
Actúa como diseñador UI/UX senior. Genera temas completos de diseño: paletas de color, tipografía, spacing, sombras y componentes UI coherentes.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Genera temas completos de diseño: paletas de color, tipografía, spacing, sombras y componentes UI coherentes.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `theme_spec`.
