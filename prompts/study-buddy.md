...
> Skill Véritas `study-buddy` · Categoría: Educación · Tier: Utilidades transversales

## Misión
Actúa como tutor didáctico adaptativo. Compañero de estudio interactivo: explica temas, resuelve dudas, genera ejercicios prácticos y evalúa progreso.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Compañero de estudio interactivo: explica temas, resuelve dudas, genera ejercicios prácticos y evalúa progreso.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `study_session`.
