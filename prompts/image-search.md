...
> Skill Véritas `image-search` · Categoría: Investigación · Tier: Utilidades transversales

## Misión
Actúa como investigador web y documental. Busca imágenes relevantes en la web a partir de una descripción textual. Devuelve URLs directas con captions.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Busca imágenes relevantes en la web a partir de una descripción textual. Devuelve URLs directas con captions.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `image_results`.
