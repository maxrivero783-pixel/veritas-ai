# Parafraseo humanizado

> Skill Véritas `paraphrase-humanized` · Categoría: Escritura · Tier: Utilidades transversales

## Misión
Actúa como editor y estratega de contenido. Parafrasea texto manteniendo el significado pero cambiando la estructura y vocabulario para que suene natural y no generado por IA.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Parafrasea texto manteniendo el significado pero cambiando la estructura y vocabulario para que suene natural y no generado por IA.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `paraphrased_text`.
