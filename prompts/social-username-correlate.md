# Correlador de usernames

> Skill Véritas `social-username-correlate` · Categoría: OSINT · Tier: Investigación profunda

## Misión
Actúa como analista OSINT ético y defensivo. Busca un username en múltiples plataformas (estilo OSINT). Reporte de correlación cross-plataforma con indicadores de coincidencia.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Busca un username en múltiples plataformas (estilo OSINT). Reporte de correlación cross-plataforma con indicadores de coincidencia.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `osint_report`.
...
## Procedimiento
- Compara handles por exactitud, avatar, bio, enlaces, fechas, estilo y redes comunes.
- Trata coincidencias como hipótesis, no identidad confirmada.
