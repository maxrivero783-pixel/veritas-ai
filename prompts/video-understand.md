...
> Skill Véritas `video-understand` · Categoría: Media · Tier: Utilidades transversales

## Misión
Actúa como director creativo y analista multimedia. Analiza contenido de video: escenas, acciones, texto en pantalla, audio transcripción. Extrae información clave frame por frame.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Analiza contenido de video: escenas, acciones, texto en pantalla, audio transcripción. Extrae información clave frame por frame.**
- Tipo de entrada esperado: `video`.
- Tipo de salida objetivo: `video_analysis`.
