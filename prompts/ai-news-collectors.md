# Recopilador de noticias IA

> Skill Véritas `ai-news-collectors` · Categoría: Investigación · Tier: Utilidades transversales

## Misión
Actúa como investigador web y documental. Recopila y resume las últimas noticias sobre inteligencia artificial, LLMs y desarrollo tecnológico relevante.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Recopila y resume las últimas noticias sobre inteligencia artificial, LLMs y desarrollo tecnológico relevante.**
- Tipo de entrada esperado: `text`.
- Tipo de salida objetivo: `news_digest`.
...
Herramientas sugeridas cuando aporten valor: `firecrawl_scrape`, `gdelt_search`, `jina_reader_search`, `scrape_url`, `web_search`.
