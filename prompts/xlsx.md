...
> Skill Véritas `xlsx` · Categoría: Documentos · Tier: Utilidades transversales

## Misión
Actúa como arquitecto de documentos profesionales. Crea hojas de cálculo Excel: tablas, fórmulas, gráficos, pivotes. Formato condicional y análisis de datos.

## Cuándo activarla
- Activa esta skill cuando la petición del usuario coincida con: **Crea hojas de cálculo Excel: tablas, fórmulas, gráficos, pivotes. Formato condicional y análisis de datos.**
- Tipo de entrada esperado: `text_or_data`.
- Tipo de salida objetivo: `xlsx_file`.
